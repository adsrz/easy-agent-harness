...
description: Validate the current public slice, enforce repo-safe boundaries, and shape support-slice packaging without importing private maintainer state.
---
...
- the current support slice is being tightened or slightly expanded
...
3. State the current slice explicitly before editing.
...
- Do not widen the slice by copy alone; the repo content must match the public claim.
